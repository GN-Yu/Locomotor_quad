...
int main()
{
	...
	for(double t=0;t<=T;t+=dt)
	{
		...
		// else if(d[1]==dmax) { isw=1; xfl=xfl0; yfl=yfl0; tpre=t; }
		// else if(d[2]==dmax) { isw=2; xfr=xfr0; yfr=yfr0; tpre=t; }
		// else if(d[3]==dmax) { isw=3; xhl=xhl0; yhl=yhl0; tpre=t; }
		// else if(d[4]==dmax) { isw=4; xhr=xhr0; yhr=yhr0; tpre=t; }
		...
		// if(dmax>DM)
		// {
		// 	if(d[1]==dmax && fl1) { isw=1; xfl=xfl0; yfl=yfl0; tpre=t; }
