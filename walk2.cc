...
int main(int argc,char** argv)
{
	...
	{
		ifstream("ini")>>xc>>yc>>vx>>vy>>theta>>omega>>Gpre
		>>xfl>>xfr>>xhl>>xhr
		>>yfl>>yfr>>yhl>>yhr
		>>sw[1]>>sw[2]>>sw[3]>>sw[4];
	}
	...
	{
		ifstream("slowini")>>xc>>yc>>vx>>vy>>theta>>omega>>Gpre
		>>xfl>>xfr>>xhl>>xhr
		>>yfl>>yfr>>yhl>>yhr
		>>sw[1]>>sw[2]>>sw[3]>>sw[4];
	}
	...
	{
		ifstream("fastini")>>xc>>yc>>vx>>vy>>theta>>omega>>Gpre
		>>xfl>>xfr>>xhl>>xhr
		>>yfl>>yfr>>yhl>>yhr
		>>sw[1]>>sw[2]>>sw[3]>>sw[4];
	}
...
//			cerr<<G[k1]<<'\t'<<G[k2]<<endl; return 1; 
		...
		cerr<<"set arrow 1 from "<<xf<<','<<yf<<" to "<<xfl<<','<<yfl<<" nohead"<<endl;
		cerr<<"set arrow 2 from "<<xf<<','<<yf<<" to "<<xfr<<','<<yfr<<" nohead"<<endl;
		cerr<<"set arrow 3 from "<<xh<<','<<yh<<" to "<<xhl<<','<<yhl<<" nohead"<<endl;
		cerr<<"set arrow 4 from "<<xh<<','<<yh<<" to "<<xhr<<','<<yhr<<" nohead"<<endl;
	...
	if(newini==1)
	{	
		ofstream("ini")<<xc<<'\t'<<yc<<'\t'<<vx<<'\t'<<vy<<'\t'<<theta<<'\t'<<omega<<'\t'<<Gpre<<endl
	...
	{	
		ofstream("slowini")<<xc<<'\t'<<yc<<'\t'<<vx<<'\t'<<vy<<'\t'<<theta<<'\t'<<omega<<'\t'<<Gpre<<endl
		<<xfl<<'\t'<<xfr<<'\t'<<xhl<<'\t'<<xhr<<endl
		<<yfl<<'\t'<<yfr<<'\t'<<yhl<<'\t'<<yhr<<endl
		<<sw[1]<<'\t'<<sw[2]<<'\t'<<sw[3]<<'\t'<<sw[4]<<endl;
	}
	...
	{	
		ofstream("fastini")<<xc<<'\t'<<yc<<'\t'<<vx<<'\t'<<vy<<'\t'<<theta<<'\t'<<omega<<'\t'<<Gpre<<endl
		<<xfl<<'\t'<<xfr<<'\t'<<xhl<<'\t'<<xhr<<endl
		<<yfl<<'\t'<<yfr<<'\t'<<yhl<<'\t'<<yhr<<endl
		<<sw[1]<<'\t'<<sw[2]<<'\t'<<sw[3]<<'\t'<<sw[4]<<endl;
	}
